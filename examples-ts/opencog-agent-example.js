...
exports.basicCognitiveAgentExample = basicCognitiveAgentExample;
exports.cognitiveCycleExample = cognitiveCycleExample;
exports.knowledgeGraphExample = knowledgeGraphExample;
exports.autonomousAgentScenario = autonomousAgentScenario;
exports.main = main;
const llama_cloud_services_1 = require("llama-cloud-services");
/**
...
function basicCognitiveAgentExample() {
    ...
    const agent = new llama_cloud_services_1.CognitiveAgent("assistant_agent");
...
function cognitiveCycleExample() {
    ...
    console.log("=".repeat(60));
    const agent = new llama_cloud_services_1.CognitiveAgent("learning_agent");
    // Setup
...
function knowledgeGraphExample() {
    ...
    console.log("=".repeat(60));
    const agent = new llama_cloud_services_1.CognitiveAgent("knowledge_agent");
    // Build knowledge graph
    console.log("\n1. Building knowledge graph...");
    // Add concepts using AtomType
    const concept1 = agent.atomspace.addAtom(llama_cloud_services_1.AtomType.CONCEPT, "Python programming");
    // Add beliefs
    ...
    const beliefs = agent.atomspace.findAtoms({ atomType: llama_cloud_services_1.AtomType.BELIEF });
    console.log(`   Found ${beliefs.length} beliefs:`);
    for (const belief of beliefs) {
        console.log(`   - ${belief.name} (strength: ${belief.truthValue.strength.toFixed(2)})`);
    }
    const goals = agent.atomspace.findAtoms({ atomType: llama_cloud_services_1.AtomType.GOAL });
...
function autonomousAgentScenario() {
    ...
    const agent = new llama_cloud_services_1.CognitiveAgent("tutorial_assistant");
